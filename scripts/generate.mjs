...
const CSS = `
:root{color-scheme:light dark;--bg:#f5f6f8;--panel:#fff;--panel-2:#fafbfc;--sunken:#f0f2f5;--text:#1a1d22;--muted:#5b6470;--faint:#8b94a1;--line:#e4e7ec;--line-2:#d4d9e0;--accent:#2f6feb;--accent-soft:#e8f0fe;--green:#1a7f47;--green-soft:#e3f5ea;--amber:#946200;--amber-soft:#fbf0d9;--red:#c0392b;--red-soft:#fbe6e3;--purple:#6b46c1;--purple-soft:#eee7fb;--shadow:0 1px 2px rgba(20,24,31,.06),0 4px 16px rgba(20,24,31,.05);--radius:11px;}
@media(prefers-color-scheme:dark){:root{--bg:#0c0e12;--panel:#15181f;--panel-2:#191c24;--sunken:#11141a;--text:#eceef2;--muted:#9aa3b2;--faint:#6c7686;--line:#262b35;--line-2:#323845;--accent:#6ea8ff;--accent-soft:#18243a;--green:#4ade80;--green-soft:#122a1c;--amber:#fbbf24;--amber-soft:#2c2410;--red:#f87171;--red-soft:#2c1614;--purple:#b388ff;--purple-soft:#211a36;--shadow:0 1px 2px rgba(0,0,0,.4),0 6px 20px rgba(0,0,0,.35);}}
